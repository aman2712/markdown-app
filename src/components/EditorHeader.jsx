...
const EditorHeader = () => {
  return (
    <div
      className="text-slate-50 flex justify-between py-3 px-6 items-center"
    ...
    >
      ...
      <div className="flex">
        <div className="w-10 h-10 rounded-full bg-orange-300 flex items-center justify-center z-20">
          A
        </div>
        <div
          className="w-10 h-10 rounded-full bg-blue-300 flex items-center justify-center z-10"
          style={{ marginLeft: -15 }}
        >
          B
        </div>
